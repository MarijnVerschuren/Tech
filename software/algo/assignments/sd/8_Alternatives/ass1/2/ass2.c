...
static void alg4(int *arr, int n)
{
	/* Here comes your implemenation of the third sorting algorithm */
}

static void alg5(int *arr, int n)
{
	/* Here comes your implemenation of the third sorting algorithm */
}
...
int main() {
	...
	printf("Execution of the third alg4 algorithm\n");

	execute_algorithm(arr1, n1, alg4);
	execute_algorithm(arr2, n2, alg4);
	execute_algorithm(arr3, n3, alg4);
	write_to_file(arr1, arr2, arr3, n1, n2, n3, "out_alg4");


	copy_input_arrays(arr1, arr2, arr3, sarr1, sarr2, sarr3, n1, n2, n3);	

	printf("Execution of the third alg5 algorithm\n");

	execute_algorithm(arr1, n1, alg5);
	execute_algorithm(arr2, n2, alg5);
	execute_algorithm(arr3, n3, alg5);
	write_to_file(arr1, arr2, arr3, n1, n2, n3, "out_alg5");
