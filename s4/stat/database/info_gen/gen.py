...
class Person:
	...
	@property
	def mail_address(self: object) -> str:			return self.__mail_account.address if self.__mail_account else None
	@property
...
class info_gen:		# generator like object
	...
	def next(self) -> Person:
		...
		mail_account =			None#Mail_Account.new_account(first_name, last_name, age, self.new_password)
